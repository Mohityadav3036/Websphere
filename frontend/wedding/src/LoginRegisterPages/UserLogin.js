      ...
      <div className="min-h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: `url(${bgImage})` }}>
        <div className="bg-black bg-opacity-30 flex rounded-lg shadow-md w-3/4 max-w-4xl border-2 border-white">
          ...
          <div className="hidden md:block w-2/4">
            <img src={loginImage} alt="Login Illustration" className="h-[400px] w-[90%] object-cover rounded-lg mt-[20px] ml-[15px]" />
          </div>
          ...
          <div className="w-full md:w-1/2 p-6 bg-transparent backdrop-blur-lg rounded-lg">
            ...
            <h2 className="text-white opacity-85 mt-[-20px] text-[17px]">
              Please sign in as <span className="text-yellow-400">Customer</span>
            </h2>
            <br />
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="mb-4 relative">
                ...
                <input
                  ...
                  className="w-full px-3 pl-10 py-2 border rounded pr-10"
                  placeholder="Enter your password"
                  required
                />
                <div className="absolute right-3 top-[38px] cursor-pointer" onClick={() => setIsPasswordVisible((prev) => !prev)}>
                  {isPasswordVisible ? <FaEyeSlash color="black" /> : <FaEye className="text-gray-500" />}
                </div>
              </div>
            ...
            <div className="mt-4 text-center">
              <a href="/users/forget-password/" className="text-blue-200 text-sm hover:underline">
                Forgot Password?
              </a>
              <br />
              <a href="/users/register" className="text-blue-200 text-sm hover:underline">
                Don't have an account? <span className="text-white">Register</span>
              </a>
              <br />
              <a href="/serviceprovider/login" className="text-blue-200 text-sm hover:underline">
                Login as Vendor
              </a>
            </div>
          </div>
